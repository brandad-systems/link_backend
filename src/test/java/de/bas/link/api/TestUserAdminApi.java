...
public class TestUserAdminApi {
    ...
    public void testCreateSuccess() throws Exception {
        ...
        MvcResult createResult = this.mockMvc
                .perform(post("/api/v1/admin/user")
    ...
    public void testEditSuccess() throws Exception {
        ...
        MvcResult updateResult = this.mockMvc
                .perform(put(String.format("/api/v1/admin/user/%s", userView.getId()))
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    public void testEditFailNotFound() throws Exception {
        ...
        this.mockMvc
                .perform(put(String.format("/api/v1/admin/user/%s", "5f07c259ffb98843e36a2aa9"))
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(toJson(objectMapper, updateRequest)))
    ...
    public void testDeleteSuccess() throws Exception {
        ...
        this.mockMvc
                .perform(delete(String.format("/api/v1/admin/user/%s", userView.getId())))
                .andExpect(status().isOk());

        this.mockMvc
                .perform(get(String.format("/api/v1/admin/user/%s", userView.getId())))
                .andExpect(status().isNotFound());
    }
    ...
    public void testDeleteFailNotFound() throws Exception {
        this.mockMvc
                .perform(delete(String.format("/api/v1/admin/user/%s", "5f07c259ffb98843e36a2aa9")))
                .andExpect(status().isNotFound())
                .andExpect(content().string(containsString("Entity User with id 5f07c259ffb98843e36a2aa9 not found")));
    }
    ...
    public void testGetNotFound() throws Exception {
        this.mockMvc
                .perform(get(String.format("/api/v1/admin/user/%s", "5f07c259ffb98843e36a2aa9")))
                .andExpect(status().isNotFound())
                .andExpect(content().string(containsString("Entity User with id 5f07c259ffb98843e36a2aa9 not found")));
    }
